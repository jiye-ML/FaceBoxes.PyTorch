...
parser.add_argument('-m', '--trained_model',
                    default='weights/FaceBoxesProd.pth',
...
parser.add_argument('--dataset', default='PASCAL', type=str,
                    choices=['AFW', 'PASCAL', 'FDDB'], help='dataset')
...
parser.add_argument('-s', '--show_image', action="store_true", default=False,
  ...
  for i, img_name in enumerate(test_dataset):
    ...
    print(
      'im_detect: {:d}/{:d} forward_pass_time: {:.4f}s misc: {:.4f}s'.format(
        i + 1, num_images, _t['forward_pass'].average_time,

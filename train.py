...
parser.add_argument('--training_dataset',
                    default='./data/WIDER_FACE/WIDER_train',
...
parser.add_argument('-max', '--max_epoch', default=300, type=int,
                    help='max epoch for retraining')
...
def train():
  ...
  for iteration in range(start_iter, max_iter):
    ...
    if iteration in stepvalues:
      step_index += 1
    lr = adjust_learning_rate(optimizer, gamma, epoch, step_index, iteration,
                              epoch_size)
